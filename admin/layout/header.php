      ...
      <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
          <div class="nav-item d-none d-md-flex me-3">
            <div class="btn-list">
              <a hidden href="https://github.com/tabler/tabler" class="btn" target="_blank" rel="noreferrer">
              ...
              <a hidden href="https://github.com/sponsors/codecalm" class="btn" target="_blank" rel="noreferrer">
          ...
          <a hidden href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="Enable dark mode" data-bs-toggle="tooltip"
          ...
          <a hidden href="?theme=light" class="nav-link px-0 hide-theme-light" title="Enable light mode"
        ...
        <div class="navbar navbar-light">
          <div class="container-xl">
            <ul class="navbar-nav">
              ...
              <li hidden class="nav-item active dropdown">
